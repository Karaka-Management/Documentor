...
<div id="header-top" class="cont">
    ...
    <nav>
        <ul>
            <li class="<?= $this->section === '' || $this->section === 'Main' ? 'active' : ''; ?>"><a href="<?= $this->base; ?>/index.html">MAIN</a><li class="<?= $this->section === 'Guide' ? 'active' : ''; ?>"><a href="<?= $this->base; ?>/guide/index.html">GUIDE</a><li class="<?= $this->section === 'Documentation' ? 'active' : ''; ?>"><a href="<?= $this->base; ?>/tableOfContents.html">DOCS</a><li class="<?= $this->section === 'Test' ? 'active' : ''; ?>"><a href="<?= $this->base; ?>/test.html">TEST</a><li class="<?= $this->section === 'Coverage' ? 'active' : ''; ?>"><a href="<?= $this->base; ?>/coverage.html">COVERAGE</a>
        </ul>
    </nav>
</div>
<header>
